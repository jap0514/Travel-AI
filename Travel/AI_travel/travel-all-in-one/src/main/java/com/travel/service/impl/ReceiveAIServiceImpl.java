...
public class ReceiveAIServiceImpl implements ReceiveAIService {
     ...
     */
    @Override
    public void sendRequestToPythonAsync(Long sessionId, Long userId, Long msg_id, String content) {
        // 构造请求体
    ...
    public ChatMessageVO receiveAIByPython(AiMessageCallbackDTO callbackDTO, Long userId) throws JsonProcessingException {
        ...
        log.info("AI回答消息已保存, msgId={}",callbackDTO.getRelatedMsgId());
        ...
        chatMessageVO.setMsgId(callbackDTO.getRelatedMsgId());
